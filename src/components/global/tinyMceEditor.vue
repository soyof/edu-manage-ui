...
const baseConfig: any = {
  ...
  content_style: 'body { font-family:Arial,sans-serif; font-size:14px; margin: 8px; padding: 0 } p { margin: 8px 0; padding: 0 }',
  ...
  plugins: 'preview importcss autolink autosave save directionality code visualblocks fullscreen image link media codesample table charmap nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons accordion wordcount',
  toolbar: 'undo redo ltr rtl blocks fontfamily fontsize bold italic underline strikethrough align numlist bullist link image table lineheight outdent indent forecolor backcolor accordion accordionremove removeformat charmap emoticons anchor codesample fullscreen wordcount preview code empty',
