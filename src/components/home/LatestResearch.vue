            ...
            <div class="research-content">
              <div class="research-header">
                ...
                <span class="research-time">
                  ...
                  {{ item.publishTimes || item.createdTimes }}
                </span>
              </div>
              ...
              <div class="research-meta">
                <span class="meta-item">
                  ...
                  {{ item.publishUserName || item.createUserName }}
                </span>
                <span class="achievement-level" :class="getAchievementLevel()">
...
import {
  Trophy, ArrowRight, Calendar, User, Star,
  Document, Medal, Reading
...
const getAchievementLevel = () => {
  const levels = ['high', 'medium', 'normal']
  return levels[Math.floor(Math.random() * levels.length)]
}

// 获取成果等级文本
const getAchievementLevelText = () => {
  const texts = ['高质量', '重要', '优秀']
